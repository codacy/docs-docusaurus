---
title: Adding repositories to Codacy programmatically
...
<ApiExamplePaginationImportant />

:::caution
Besides this, the script doesn't consider paginated results obtained from the GitHub API. [Learn how to use pagination on the GitHub API](https://docs.github.com/en/rest/using-the-rest-api/using-pagination-in-the-rest-api) to ensure that you obtain all the repositories in your organization.
:::
