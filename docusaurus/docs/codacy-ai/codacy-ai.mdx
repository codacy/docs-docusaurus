...
title: Codacy AI
---
import Paid from "../_includes/Paid.mdx"
...
1. Get in touch with your Customer Success Manager or with [support@codacy.com](mailto:support@codacy.com)
